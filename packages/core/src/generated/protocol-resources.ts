...
export const protocolResources = [
  ...
  },
  {
    ...
    "uri": "masa://spec/0.2.0/vocabulary",
    "mimeType": "text/markdown",
...
export const referenceCapabilitySet = {
  ...
  "capabilitySetVersion": "0.2.0",
  "masaVersion": "0.2.0",
  "id": "https://masa.sonicfield.org/capabilities/0.2.0/reference",
  "implementation": {
    "id": "https://masa.sonicfield.org/implementations/typescript-reference/0.2.0",
  ...
  "capabilities": [
    {
      ...
      "inputSchema": {
        "state": "known",
        "uri": "https://masa.sonicfield.org/schemas/0.2.0/tools/validate-input.schema.json"
      },
      "outputSchema": {
        "state": "known",
        "uri": "https://masa.sonicfield.org/schemas/0.2.0/tools/tool-result.schema.json"
      },
      "resources": {
        "local": [
          "configured-roots"
    ...
    {
      "id": "https://masa.sonicfield.org/capabilities/0.2.0/matter.inspect",
      "type": "masa:Capability",
      "name": "matter.inspect",
      ...
      "inputSchema": {
        "state": "known",
        "uri": "https://masa.sonicfield.org/schemas/0.2.0/tools/inspect-input.schema.json"
      },
      "outputSchema": {
        "state": "known",
        "uri": "https://masa.sonicfield.org/schemas/0.2.0/tools/tool-result.schema.json"
    ...
    {
      "id": "https://masa.sonicfield.org/capabilities/0.2.0/matter.trace_lineage",
      "type": "masa:Capability",
      ...
      "inputSchema": {
        "state": "known",
        "uri": "https://masa.sonicfield.org/schemas/0.2.0/tools/trace-lineage-input.schema.json"
      },
      "outputSchema": {
        "state": "known",
        "uri": "https://masa.sonicfield.org/schemas/0.2.0/tools/tool-result.schema.json"
    ...
    {
      "id": "https://masa.sonicfield.org/capabilities/0.2.0/matter.audit_public_export",
      "type": "masa:Capability",
      ...
      "inputSchema": {
        "state": "known",
        "uri": "https://masa.sonicfield.org/schemas/0.2.0/tools/audit-public-input.schema.json"
      },
      "outputSchema": {
        "state": "known",
        "uri": "https://masa.sonicfield.org/schemas/0.2.0/tools/tool-result.schema.json"
    ...
    {
      "id": "https://masa.sonicfield.org/capabilities/0.2.0/matter.plan_processing",
      "type": "masa:Capability",
      ...
      "inputSchema": {
        "state": "known",
        "uri": "https://masa.sonicfield.org/schemas/0.2.0/tools/plan-processing-input.schema.json"
      },
      "outputSchema": {
        "state": "known",
        "uri": "https://masa.sonicfield.org/schemas/0.2.0/tools/tool-result.schema.json"
